$(document).ready(function(){
    ...
    //sets the delayed amlunt of time between each repeat
    ...
    $("#classicCars").on({
        ...
        //Triggers the images to slide down one afer the other
        ...
        //one after th eother when the user's mouse leaves
